            ...
            <div class="middle-column">
                ...
                <div class="container" id="baseballMessage">
                    ...
                    <div class="stats-container">
                        ...
                        <div class="hitter-stats" id="hitterStats">
                            ...
                            <div class="stat-row">
                                <span class="stat-label">Walk (Base on Balls) = 2</span>
                                <span class="stat-value">2</span>
                                <input type="number" class="stat-input hitter-input" data-multiplier="2" data-name="Walk (Base on Balls)" placeholder="">
                            </div>
                            <div class="stat-row">
                ...
                <div class="container" id="mmaMessage">
                    ...
                    <div class="mma-stats" id="mmaStats">
                        ...
                        <div class="stat-row">
                            <span class="stat-label">Submission Attempt = 4</span>
                            <span class="stat-value">4</span>
                            <input type="number" class="stat-input mma-input" data-multiplier="4" data-name="Submission Attempt" placeholder="">
                        </div>
                        <div class="stat-row">
                            <span class="stat-label">Takedown = 5</span>
                            <span class="stat-value">5</span>
                            <input type="number" class="stat-input mma-input" data-multiplier="5" data-name="Takedown" placeholder="">
                        </div>
                        <div class="stat-row">
                            <span class="stat-label">Knockdown = 10</span>
                            <span class="stat-value">10</span>
                            <input type="number" class="stat-input mma-input" data-multiplier="10" data-name="Knockdown" placeholder="">
                        </div>
                        <div class="stat-row">
                            <span class="stat-label">1st Round Win = 50</span>
                            <span class="stat-value">50</span>
                            <input type="number" class="stat-input mma-input" data-multiplier="50" data-name="1st Round Win" placeholder="">
                        </div>
                        <div class="stat-row">
                            <span class="stat-label">2nd Round Win = 40</span>
                            <span class="stat-value">40</span>
                            <input type="number" class="stat-input mma-input" data-multiplier="40" data-name="2nd Round Win" placeholder="">
                        </div>
                        <div class="stat-row">
                            <span class="stat-label">3rd Round Win = 30</span>
                            <span class="stat-value">30</span>
                            <input type="number" class="stat-input mma-input" data-multiplier="30" data-name="3rd Round Win" placeholder="">
                        </div>
			<div class="stat-row">
                            <span class="stat-label">4th Round Win = 20</span>
                            <span class="stat-value">20</span>
                            <input type="number" class="stat-input mma-input" data-multiplier="20" data-name="4th Round Win" placeholder="">
                        </div>
			<div class="stat-row">
                            <span class="stat-label">5th Round Win = 20</span>
                            <span class="stat-value">20</span>
                            <input type="number" class="stat-input mma-input" data-multiplier="20" data-name="5th Round Win" placeholder="">
                        </div>
			<div class="stat-row">
                            <span class="stat-label">Decision Win = 10</span>
                            <span class="stat-value">10</span>
                            <input type="number" class="stat-input mma-input" data-multiplier="10" data-name="Decision Win" placeholder="">
                        </div>
			<div class="stat-row">
                            <span class="stat-label">Draw = 0</span>
                            <span class="stat-value">0</span>
                            <input type="number" class="stat-input mma-input" data-multiplier="0" data-name="Draw" placeholder="">
                        </div>
				...
				<div class="stat-row">
                            ...
                            <div class="stat-row">
                                <span class="stat-label">2 Point Conversions = 2</span>
                                <span class="stat-value">2</span>
                                <input type="number" class="stat-input football-offensive-input" data-multiplier="2" data-name="2 Point Conversions" placeholder="">
                            </div>
                            <div class="stat-row">
                                <span class="stat-label">Offensive Fumble Recovery Touchdown = 6</span>
                                <span class="stat-value">6</span>
                                <input type="number" class="stat-input football-offensive-input" data-multiplier="6" data-name="Offensive Fumble Recovery Touchdown" placeholder="">
                            </div>
                            <div class="stat-row">
                                <span class="stat-label">Kick/Punt/Field Goal Return Touchdown = 6</span>
                                <span class="stat-value">6</span>
                                <input type="number" class="stat-input football-offensive-input" data-multiplier="6" data-name="Kick/Punt/Field Goal Return Touchdown" placeholder="">
                            </div>
